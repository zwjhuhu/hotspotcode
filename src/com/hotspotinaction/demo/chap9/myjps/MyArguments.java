...
package com.hotspotinaction.demo.chap9.myjps;
...
public class MyArguments {
	...
	private boolean jvmCapabilities;
	private boolean listMonitors;
	...
	public MyArguments(String[] args) throws IllegalArgumentException {
		int argc = 0;
	 ...
	 * @return
	 */
	public boolean showJvmCapabilities() {
		return jvmCapabilities;
	}
